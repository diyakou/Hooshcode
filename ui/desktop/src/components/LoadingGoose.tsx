...
const i18n = defineMessages({
  ...
  thinking: {
    ...
    defaultMessage: 'Houshiar Code is thinking…',
  },
  streaming: {
    id: 'loadingGoose.streaming',
    defaultMessage: 'Houshiar Code is working on it…',
  },
  waiting: {
    id: 'loadingGoose.waiting',
    defaultMessage: 'Houshiar Code is waiting…',
  },
  compacting: {
    id: 'loadingGoose.compacting',
    defaultMessage: 'Houshiar Code is compacting the conversation...',
  },
  idle: {

...
const i18n = defineMessages({
  ...
  description: {
    ...
    defaultMessage: 'Anonymous usage data helps us understand how Houshiar Code is used and identify areas for improvement.',
  },
  whatWeCollect: {
  ...
  collectVersion: {
    ...
    defaultMessage: 'Houshiar Code version and install method',
  },
  collectProvider: {

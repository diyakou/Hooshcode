...
const i18n = defineMessages({
  ...
  allSet: {
    ...
    defaultMessage: "You're all set to start using Houshiar Code.",
  },
  privacyTitle: {
  ...
  privacyDescription: {
    ...
    defaultMessage: 'Anonymous usage data helps improve Houshiar Code. We never collect your conversations, code, or personal data.',
  },
  learnMore: {

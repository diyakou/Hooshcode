...
const i18n = defineMessages({
  ...
  disableAutoDownloadDesc: {
    ...
    defaultMessage:
      'When enabled, Houshiar Code will notify you of new versions but will not download them automatically.',
  },
  ...
  autoDownload: {
    ...
    defaultMessage:
      'Houshiar Code will download the update in the background and install it the next time you quit or restart.',
  },
});

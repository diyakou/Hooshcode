...
const i18n = defineMessages({
  ...
  onboardingDescription: {
    ...
    defaultMessage: "Select an AI model provider to get started with Houshiar Code. You'll need to use API keys generated by each provider which will be encrypted and stored locally. You can change your provider at any time in settings.",
  },
  loadingProviders: {
